...
class Settings(BaseSettings):
    ...
    whisper_model_name: str = Field(default="large-v3", alias="WHISPER_MODEL_NAME")
    whisper_download_root: str = Field(default="/tmp/whisper-cache", alias="WHISPER_DOWNLOAD_ROOT")
