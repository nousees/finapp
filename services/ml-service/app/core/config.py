...
class Settings(BaseSettings):
    ...
    allow_demo_transcription: bool = Field(default=False, alias="ALLOW_DEMO_TRANSCRIPTION")
    whisper_model_path: str = Field(default="/models/whisper-large-v3", alias="WHISPER_MODEL_PATH")
    whisper_model_id: str = Field(default="openai/whisper-large-v3", alias="WHISPER_MODEL_ID")
    whisper_download_root: str = Field(default="/tmp/huggingface", alias="WHISPER_DOWNLOAD_ROOT")
