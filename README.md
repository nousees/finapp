...
/api/v1/voice/upload    → collection:8082 (загрузка голоса, сохранение)
/api/v1/voice/transaction → collection:8082 (распознавание + обогащение)
/api/v1/voice/transcribe → ml-service:8000 (прямое распознавание, fallback)
