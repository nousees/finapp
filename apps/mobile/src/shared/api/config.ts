...
export const apiConfig = {
  collectionBaseUrl: process.env.EXPO_PUBLIC_COLLECTION_API_URL?.trim() || `http://${host}:8086`,
  ...
  analysisBaseUrl: process.env.EXPO_PUBLIC_ANALYSIS_API_URL?.trim() || `http://${host}:8084`,
  mlBaseUrl: process.env.EXPO_PUBLIC_ML_API_URL?.trim() || `http://${host}:8000`,
